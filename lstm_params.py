...
class lstm_param:
    ...
    def __init__(self, units, x_dim, features, classes, beta_1, beta_2):
        ...
        self.wr = util.rand_arr(-0.1, 0.1, classes, features)
        ...
        self.br = util.rand_arr(-0.1, 0.1, classes, features)
        ...
        self.wr_diff = np.zeros((classes, features))
        ...
        self.br_diff = np.zeros((classes, features))
        ...
        self.adam_m_wr = np.zeros((units, classes))
